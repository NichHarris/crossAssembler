...
//Java.Options class - Determine and check validity of options provided by the developer from the command line
public class Options implements IOptions {
    ...
    public void displayHelp() {
        ...
        System.out.println("   -h, --help      Displays Cross Java.Assembler Usage and Valid Java.Options");
        System.out.println("   -l, --listing   Generates Source Java.Listing File Alongside Executable File");
        System.out.println("   -v, --verbose   Generates Source Java.Listing File and Label Table Alongside Executable File");
    }
}
