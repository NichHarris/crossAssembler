...
//Java.Listing object used to generate listing file content
public class Listing implements IListing {

    //Java.InterRep object for which the listing content is derived
    ...
    public Listing(IInterRep intRep) {
        ...
        for (int i = 0; i < IR.getLength(); i++){
            try {
                ...
                //Check If Java.Instruction Exists
