...
import Interfaces.ILabelTable;

import java.util.HashMap;

//Used to store seen labels, to be refered to on second pass for offset or addr location (depending on how we want to implement it)
