...
public class CodeGeneratorTest {
    ...
    public static void main(String[] args) throws Exception{
        ...
        //Creating an Java.Instruction
        IInstruction instruction = new Instruction(m, op);

        //Creating a Java.LineStatement with Java.Instruction
        ...
        TestCodeGenerator("Test -Java.CodeGenerator Class- File creation",
