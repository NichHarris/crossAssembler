...
public class LineStatementTest {
    public static void main(String[] args) throws Exception {
        ...
        TestLineStatement("Test -Java.LineStatement Class- Default Constructor", " 'null null' ", ls.getLabel() + " " + ls.getInstruction() + " " + ls.getComment());
        ...
        TestLineStatement("Test -Java.LineStatement Class- Parameterized Constructor with label, instruction and comment", "Fct 'addv.u3 3' ", ls1.getLabel() + " " + ls1.getInstruction().toString() + " " + ls1.getComment());

        //Testing setLabel() and getLabel()
        ls1.setLabel("RA");
        TestLineStatement("Test -Java.LineStatement Class- setLabel()", "RA", ls1.getLabel());
        ...
        TestLineStatement("Test -Java.LineStatement Class- setInstruction() and getInstruction", "'mul 4'", ls1.getInstruction().toString());

        //Testing setComment() and getComment()
        ls1.setComment("; new comment");
        TestLineStatement("Test -Java.LineStatement Class- setComment()", "; new comment", ls1.getComment());

        //Testing the function getLabel()
        TestLineStatement("Test -Java.LineStatement Class- getLabel()","RA", ls1.getLabel());
    }
